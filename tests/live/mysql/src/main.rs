...
async fn main() {
    let mut connection = setup("mysql://sea:sea@localhost", "sea-schema").await;
...
fn create_baker_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(ColumnDef::new(Alias::new("bakery_id")).integer_len(11))
        .index(
            Index::create()
...
fn create_lineitem_table() -> TableCreateStatement {
    Table::create()
        ...
        .col(ColumnDef::new(Alias::new("quantity")).integer_len(11))
        .col(
