...
pub enum Collation {
    ...
    #[iden = "armscii8_bin"] Armscii8Bin,
    #[iden = "ascii_general_ci"] AsciiGeneralCi,
    #[iden = "ascii_bin"] AsciiBin,
    #[iden = "big5_chinese_ci"] Big5ChineseCi,
    #[iden = "big5_bin"] Big5Bin,
    #[iden = "binary"] Binary,
    #[iden = "cp1250_general_ci"] Cp1250GeneralCi,
    #[iden = "cp1250_czech_cs"] Cp1250CzechCs,
    #[iden = "cp1250_croatian_ci"] Cp1250CroatianCi,
    #[iden = "cp1250_bin"] Cp1250Bin,
    #[iden = "cp1250_polish_ci"] Cp1250PolishCi,
    #[iden = "cp1251_bulgarian_ci"] Cp1251BulgarianCi,
    #[iden = "cp1251_ukrainian_ci"] Cp1251UkrainianCi,
    #[iden = "cp1251_bin"] Cp1251Bin,
    #[iden = "cp1251_general_ci"] Cp1251GeneralCi,
    #[iden = "cp1251_general_cs"] Cp1251GeneralCs,
    #[iden = "cp1256_general_ci"] Cp1256GeneralCi,
    #[iden = "cp1256_bin"] Cp1256Bin,
    #[iden = "cp1257_lithuanian_ci"] Cp1257LithuanianCi,
    #[iden = "cp1257_bin"] Cp1257Bin,
    #[iden = "cp1257_general_ci"] Cp1257GeneralCi,
    #[iden = "cp850_general_ci"] Cp850GeneralCi,
    #[iden = "cp850_bin"] Cp850Bin,
    #[iden = "cp852_general_ci"] Cp852GeneralCi,
    #[iden = "cp852_bin"] Cp852Bin,
    #[iden = "cp866_general_ci"] Cp866GeneralCi,
    #[iden = "cp866_bin"] Cp866Bin,
    #[iden = "cp932_japanese_ci"] Cp932JapaneseCi,
    #[iden = "cp932_bin"] Cp932Bin,
    #[iden = "dec8_swedish_ci"] Dec8SwedishCi,
    #[iden = "dec8_bin"] Dec8Bin,
    #[iden = "eucjpms_japanese_ci"] EucjpmsJapaneseCi,
    #[iden = "eucjpms_bin"] EucjpmsBin,
    #[iden = "euckr_korean_ci"] EuckrKoreanCi,
    #[iden = "euckr_bin"] EuckrBin,
    #[iden = "gb18030_chinese_ci"] Gb18030ChineseCi,
    #[iden = "gb18030_bin"] Gb18030Bin,
    #[iden = "gb18030_unicode_520_ci"] Gb18030Unicode520Ci,
    #[iden = "gb2312_chinese_ci"] Gb2312ChineseCi,
    #[iden = "gb2312_bin"] Gb2312Bin,
    #[iden = "gbk_chinese_ci"] GbkChineseCi,
    #[iden = "gbk_bin"] GbkBin,
    #[iden = "geostd8_general_ci"] Geostd8GeneralCi,
    #[iden = "geostd8_bin"] Geostd8Bin,
    #[iden = "greek_general_ci"] GreekGeneralCi,
    #[iden = "greek_bin"] GreekBin,
    #[iden = "hebrew_general_ci"] HebrewGeneralCi,
    #[iden = "hebrew_bin"] HebrewBin,
    #[iden = "hp8_english_ci"] Hp8EnglishCi,
    #[iden = "hp8_bin"] Hp8Bin,
    #[iden = "keybcs2_general_ci"] Keybcs2GeneralCi,
    #[iden = "keybcs2_bin"] Keybcs2Bin,
    #[iden = "koi8r_general_ci"] Koi8RGeneralCi,
    #[iden = "koi8r_bin"] Koi8RBin,
    #[iden = "koi8u_general_ci"] Koi8UGeneralCi,
    #[iden = "koi8u_bin"] Koi8UBin,
    #[iden = "latin1_german1_ci"] Latin1German1Ci,
    #[iden = "latin1_swedish_ci"] Latin1SwedishCi,
    #[iden = "latin1_danish_ci"] Latin1DanishCi,
    #[iden = "latin1_german2_ci"] Latin1German2Ci,
    #[iden = "latin1_bin"] Latin1Bin,
    #[iden = "latin1_general_ci"] Latin1GeneralCi,
    #[iden = "latin1_general_cs"] Latin1GeneralCs,
    #[iden = "latin1_spanish_ci"] Latin1SpanishCi,
    #[iden = "latin2_czech_cs"] Latin2CzechCs,
    #[iden = "latin2_general_ci"] Latin2GeneralCi,
    #[iden = "latin2_hungarian_ci"] Latin2HungarianCi,
    #[iden = "latin2_croatian_ci"] Latin2CroatianCi,
    #[iden = "latin2_bin"] Latin2Bin,
    #[iden = "latin5_turkish_ci"] Latin5TurkishCi,
    #[iden = "latin5_bin"] Latin5Bin,
    #[iden = "latin7_estonian_cs"] Latin7EstonianCs,
    #[iden = "latin7_general_ci"] Latin7GeneralCi,
    #[iden = "latin7_general_cs"] Latin7GeneralCs,
    #[iden = "latin7_bin"] Latin7Bin,
    #[iden = "macce_general_ci"] MacceGeneralCi,
    #[iden = "macce_bin"] MacceBin,
    #[iden = "macroman_general_ci"] MacromanGeneralCi,
    #[iden = "macroman_bin"] MacromanBin,
    #[iden = "sjis_japanese_ci"] SjisJapaneseCi,
    #[iden = "sjis_bin"] SjisBin,
    #[iden = "swe7_swedish_ci"] Swe7SwedishCi,
    #[iden = "swe7_bin"] Swe7Bin,
    #[iden = "tis620_thai_ci"] Tis620ThaiCi,
    #[iden = "tis620_bin"] Tis620Bin,
    #[iden = "ucs2_general_ci"] Ucs2GeneralCi,
    #[iden = "ucs2_bin"] Ucs2Bin,
    #[iden = "ucs2_unicode_ci"] Ucs2UnicodeCi,
    #[iden = "ucs2_icelandic_ci"] Ucs2IcelandicCi,
    #[iden = "ucs2_latvian_ci"] Ucs2LatvianCi,
    #[iden = "ucs2_romanian_ci"] Ucs2RomanianCi,
    #[iden = "ucs2_slovenian_ci"] Ucs2SlovenianCi,
    #[iden = "ucs2_polish_ci"] Ucs2PolishCi,
    #[iden = "ucs2_estonian_ci"] Ucs2EstonianCi,
    #[iden = "ucs2_spanish_ci"] Ucs2SpanishCi,
    #[iden = "ucs2_swedish_ci"] Ucs2SwedishCi,
    #[iden = "ucs2_turkish_ci"] Ucs2TurkishCi,
    #[iden = "ucs2_czech_ci"] Ucs2CzechCi,
    #[iden = "ucs2_danish_ci"] Ucs2DanishCi,
    #[iden = "ucs2_lithuanian_ci"] Ucs2LithuanianCi,
    #[iden = "ucs2_slovak_ci"] Ucs2SlovakCi,
    #[iden = "ucs2_spanish2_ci"] Ucs2Spanish2Ci,
    #[iden = "ucs2_roman_ci"] Ucs2RomanCi,
    #[iden = "ucs2_persian_ci"] Ucs2PersianCi,
    #[iden = "ucs2_esperanto_ci"] Ucs2EsperantoCi,
    #[iden = "ucs2_hungarian_ci"] Ucs2HungarianCi,
    #[iden = "ucs2_sinhala_ci"] Ucs2SinhalaCi,
    #[iden = "ucs2_german2_ci"] Ucs2German2Ci,
    #[iden = "ucs2_croatian_ci"] Ucs2CroatianCi,
    #[iden = "ucs2_unicode_520_ci"] Ucs2Unicode520Ci,
    #[iden = "ucs2_vietnamese_ci"] Ucs2VietnameseCi,
    #[iden = "ucs2_general_mysql500_ci"] Ucs2GeneralMysql500Ci,
    #[iden = "ujis_japanese_ci"] UjisJapaneseCi,
    #[iden = "ujis_bin"] UjisBin,
    #[iden = "utf16_general_ci"] Utf16GeneralCi,
    #[iden = "utf16_bin"] Utf16Bin,
    #[iden = "utf16_unicode_ci"] Utf16UnicodeCi,
    #[iden = "utf16_icelandic_ci"] Utf16IcelandicCi,
    #[iden = "utf16_latvian_ci"] Utf16LatvianCi,
    #[iden = "utf16_romanian_ci"] Utf16RomanianCi,
    #[iden = "utf16_slovenian_ci"] Utf16SlovenianCi,
    #[iden = "utf16_polish_ci"] Utf16PolishCi,
    #[iden = "utf16_estonian_ci"] Utf16EstonianCi,
    #[iden = "utf16_spanish_ci"] Utf16SpanishCi,
    #[iden = "utf16_swedish_ci"] Utf16SwedishCi,
    #[iden = "utf16_turkish_ci"] Utf16TurkishCi,
    #[iden = "utf16_czech_ci"] Utf16CzechCi,
    #[iden = "utf16_danish_ci"] Utf16DanishCi,
    #[iden = "utf16_lithuanian_ci"] Utf16LithuanianCi,
    #[iden = "utf16_slovak_ci"] Utf16SlovakCi,
    #[iden = "utf16_spanish2_ci"] Utf16Spanish2Ci,
    #[iden = "utf16_roman_ci"] Utf16RomanCi,
    #[iden = "utf16_persian_ci"] Utf16PersianCi,
    #[iden = "utf16_esperanto_ci"] Utf16EsperantoCi,
    #[iden = "utf16_hungarian_ci"] Utf16HungarianCi,
    #[iden = "utf16_sinhala_ci"] Utf16SinhalaCi,
    #[iden = "utf16_german2_ci"] Utf16German2Ci,
    #[iden = "utf16_croatian_ci"] Utf16CroatianCi,
    #[iden = "utf16_unicode_520_ci"] Utf16Unicode520Ci,
    #[iden = "utf16_vietnamese_ci"] Utf16VietnameseCi,
    #[iden = "utf16le_general_ci"] Utf16LeGeneralCi,
    #[iden = "utf16le_bin"] Utf16LeBin,
    #[iden = "utf32_general_ci"] Utf32GeneralCi,
    #[iden = "utf32_bin"] Utf32Bin,
    #[iden = "utf32_unicode_ci"] Utf32UnicodeCi,
    #[iden = "utf32_icelandic_ci"] Utf32IcelandicCi,
    #[iden = "utf32_latvian_ci"] Utf32LatvianCi,
    #[iden = "utf32_romanian_ci"] Utf32RomanianCi,
    #[iden = "utf32_slovenian_ci"] Utf32SlovenianCi,
    #[iden = "utf32_polish_ci"] Utf32PolishCi,
    #[iden = "utf32_estonian_ci"] Utf32EstonianCi,
    #[iden = "utf32_spanish_ci"] Utf32SpanishCi,
    #[iden = "utf32_swedish_ci"] Utf32SwedishCi,
    #[iden = "utf32_turkish_ci"] Utf32TurkishCi,
    #[iden = "utf32_czech_ci"] Utf32CzechCi,
    #[iden = "utf32_danish_ci"] Utf32DanishCi,
    #[iden = "utf32_lithuanian_ci"] Utf32LithuanianCi,
    #[iden = "utf32_slovak_ci"] Utf32SlovakCi,
    #[iden = "utf32_spanish2_ci"] Utf32Spanish2Ci,
    #[iden = "utf32_roman_ci"] Utf32RomanCi,
    #[iden = "utf32_persian_ci"] Utf32PersianCi,
    #[iden = "utf32_esperanto_ci"] Utf32EsperantoCi,
    #[iden = "utf32_hungarian_ci"] Utf32HungarianCi,
    #[iden = "utf32_sinhala_ci"] Utf32SinhalaCi,
    #[iden = "utf32_german2_ci"] Utf32German2Ci,
    #[iden = "utf32_croatian_ci"] Utf32CroatianCi,
    #[iden = "utf32_unicode_520_ci"] Utf32Unicode520Ci,
    #[iden = "utf32_vietnamese_ci"] Utf32VietnameseCi,
    #[iden = "utf8_general_ci"] Utf8GeneralCi,
    #[iden = "utf8_tolower_ci"] Utf8TolowerCi,
    #[iden = "utf8_bin"] Utf8Bin,
    #[iden = "utf8_unicode_ci"] Utf8UnicodeCi,
    #[iden = "utf8_icelandic_ci"] Utf8IcelandicCi,
    #[iden = "utf8_latvian_ci"] Utf8LatvianCi,
    #[iden = "utf8_romanian_ci"] Utf8RomanianCi,
    #[iden = "utf8_slovenian_ci"] Utf8SlovenianCi,
    #[iden = "utf8_polish_ci"] Utf8PolishCi,
    #[iden = "utf8_estonian_ci"] Utf8EstonianCi,
    #[iden = "utf8_spanish_ci"] Utf8SpanishCi,
    #[iden = "utf8_swedish_ci"] Utf8SwedishCi,
    #[iden = "utf8_turkish_ci"] Utf8TurkishCi,
    #[iden = "utf8_czech_ci"] Utf8CzechCi,
    #[iden = "utf8_danish_ci"] Utf8DanishCi,
    #[iden = "utf8_lithuanian_ci"] Utf8LithuanianCi,
    #[iden = "utf8_slovak_ci"] Utf8SlovakCi,
    #[iden = "utf8_spanish2_ci"] Utf8Spanish2Ci,
    #[iden = "utf8_roman_ci"] Utf8RomanCi,
    #[iden = "utf8_persian_ci"] Utf8PersianCi,
    #[iden = "utf8_esperanto_ci"] Utf8EsperantoCi,
    #[iden = "utf8_hungarian_ci"] Utf8HungarianCi,
    #[iden = "utf8_sinhala_ci"] Utf8SinhalaCi,
    #[iden = "utf8_german2_ci"] Utf8German2Ci,
    #[iden = "utf8_croatian_ci"] Utf8CroatianCi,
    #[iden = "utf8_unicode_520_ci"] Utf8Unicode520Ci,
    #[iden = "utf8_vietnamese_ci"] Utf8VietnameseCi,
    #[iden = "utf8_general_mysql500_ci"] Utf8GeneralMysql500Ci,
    #[iden = "utf8mb4_general_ci"] Utf8Mb4GeneralCi,
    #[iden = "utf8mb4_bin"] Utf8Mb4Bin,
    #[iden = "utf8mb4_unicode_ci"] Utf8Mb4UnicodeCi,
    #[iden = "utf8mb4_icelandic_ci"] Utf8Mb4IcelandicCi,
    #[iden = "utf8mb4_latvian_ci"] Utf8Mb4LatvianCi,
    #[iden = "utf8mb4_romanian_ci"] Utf8Mb4RomanianCi,
    #[iden = "utf8mb4_slovenian_ci"] Utf8Mb4SlovenianCi,
    #[iden = "utf8mb4_polish_ci"] Utf8Mb4PolishCi,
    #[iden = "utf8mb4_estonian_ci"] Utf8Mb4EstonianCi,
    #[iden = "utf8mb4_spanish_ci"] Utf8Mb4SpanishCi,
    #[iden = "utf8mb4_swedish_ci"] Utf8Mb4SwedishCi,
    #[iden = "utf8mb4_turkish_ci"] Utf8Mb4TurkishCi,
    #[iden = "utf8mb4_czech_ci"] Utf8Mb4CzechCi,
    #[iden = "utf8mb4_danish_ci"] Utf8Mb4DanishCi,
    #[iden = "utf8mb4_lithuanian_ci"] Utf8Mb4LithuanianCi,
    #[iden = "utf8mb4_slovak_ci"] Utf8Mb4SlovakCi,
    #[iden = "utf8mb4_spanish2_ci"] Utf8Mb4Spanish2Ci,
    #[iden = "utf8mb4_roman_ci"] Utf8Mb4RomanCi,
    #[iden = "utf8mb4_persian_ci"] Utf8Mb4PersianCi,
    #[iden = "utf8mb4_esperanto_ci"] Utf8Mb4EsperantoCi,
    #[iden = "utf8mb4_hungarian_ci"] Utf8Mb4HungarianCi,
    #[iden = "utf8mb4_sinhala_ci"] Utf8Mb4SinhalaCi,
    #[iden = "utf8mb4_german2_ci"] Utf8Mb4German2Ci,
    #[iden = "utf8mb4_croatian_ci"] Utf8Mb4CroatianCi,
    #[iden = "utf8mb4_unicode_520_ci"] Utf8Mb4Unicode520Ci,
    #[iden = "utf8mb4_vietnamese_ci"] Utf8Mb4VietnameseCi,
    #[iden = "utf8mb4_0900_ai_ci"] Utf8Mb40900AiCi,
    #[iden = "utf8mb4_de_pb_0900_ai_ci"] Utf8Mb4DePb0900AiCi,
    #[iden = "utf8mb4_is_0900_ai_ci"] Utf8Mb4Is0900AiCi,
    #[iden = "utf8mb4_lv_0900_ai_ci"] Utf8Mb4Lv0900AiCi,
    #[iden = "utf8mb4_ro_0900_ai_ci"] Utf8Mb4Ro0900AiCi,
    #[iden = "utf8mb4_sl_0900_ai_ci"] Utf8Mb4Sl0900AiCi,
    #[iden = "utf8mb4_pl_0900_ai_ci"] Utf8Mb4Pl0900AiCi,
    #[iden = "utf8mb4_et_0900_ai_ci"] Utf8Mb4Et0900AiCi,
    #[iden = "utf8mb4_es_0900_ai_ci"] Utf8Mb4Es0900AiCi,
    #[iden = "utf8mb4_sv_0900_ai_ci"] Utf8Mb4Sv0900AiCi,
    #[iden = "utf8mb4_tr_0900_ai_ci"] Utf8Mb4Tr0900AiCi,
    #[iden = "utf8mb4_cs_0900_ai_ci"] Utf8Mb4Cs0900AiCi,
    #[iden = "utf8mb4_da_0900_ai_ci"] Utf8Mb4Da0900AiCi,
    #[iden = "utf8mb4_lt_0900_ai_ci"] Utf8Mb4Lt0900AiCi,
    #[iden = "utf8mb4_sk_0900_ai_ci"] Utf8Mb4Sk0900AiCi,
    #[iden = "utf8mb4_es_trad_0900_ai_ci"] Utf8Mb4EsTrad0900AiCi,
    #[iden = "utf8mb4_la_0900_ai_ci"] Utf8Mb4La0900AiCi,
    #[iden = "utf8mb4_eo_0900_ai_ci"] Utf8Mb4Eo0900AiCi,
    #[iden = "utf8mb4_hu_0900_ai_ci"] Utf8Mb4Hu0900AiCi,
    #[iden = "utf8mb4_hr_0900_ai_ci"] Utf8Mb4Hr0900AiCi,
    #[iden = "utf8mb4_vi_0900_ai_ci"] Utf8Mb4Vi0900AiCi,
    #[iden = "utf8mb4_0900_as_cs"] Utf8Mb40900AsCs,
    #[iden = "utf8mb4_de_pb_0900_as_cs"] Utf8Mb4DePb0900AsCs,
    #[iden = "utf8mb4_is_0900_as_cs"] Utf8Mb4Is0900AsCs,
    #[iden = "utf8mb4_lv_0900_as_cs"] Utf8Mb4Lv0900AsCs,
    #[iden = "utf8mb4_ro_0900_as_cs"] Utf8Mb4Ro0900AsCs,
    #[iden = "utf8mb4_sl_0900_as_cs"] Utf8Mb4Sl0900AsCs,
    #[iden = "utf8mb4_pl_0900_as_cs"] Utf8Mb4Pl0900AsCs,
    #[iden = "utf8mb4_et_0900_as_cs"] Utf8Mb4Et0900AsCs,
    #[iden = "utf8mb4_es_0900_as_cs"] Utf8Mb4Es0900AsCs,
    #[iden = "utf8mb4_sv_0900_as_cs"] Utf8Mb4Sv0900AsCs,
    #[iden = "utf8mb4_tr_0900_as_cs"] Utf8Mb4Tr0900AsCs,
    #[iden = "utf8mb4_cs_0900_as_cs"] Utf8Mb4Cs0900AsCs,
    #[iden = "utf8mb4_da_0900_as_cs"] Utf8Mb4Da0900AsCs,
    #[iden = "utf8mb4_lt_0900_as_cs"] Utf8Mb4Lt0900AsCs,
    #[iden = "utf8mb4_sk_0900_as_cs"] Utf8Mb4Sk0900AsCs,
    #[iden = "utf8mb4_es_trad_0900_as_cs"] Utf8Mb4EsTrad0900AsCs,
    #[iden = "utf8mb4_la_0900_as_cs"] Utf8Mb4La0900AsCs,
    #[iden = "utf8mb4_eo_0900_as_cs"] Utf8Mb4Eo0900AsCs,
    #[iden = "utf8mb4_hu_0900_as_cs"] Utf8Mb4Hu0900AsCs,
    #[iden = "utf8mb4_hr_0900_as_cs"] Utf8Mb4Hr0900AsCs,
    #[iden = "utf8mb4_vi_0900_as_cs"] Utf8Mb4Vi0900AsCs,
    #[iden = "utf8mb4_ja_0900_as_cs"] Utf8Mb4Ja0900AsCs,
    #[iden = "utf8mb4_ja_0900_as_cs_ks"] Utf8Mb4Ja0900AsCsKs,
    #[iden = "utf8mb4_0900_as_ci"] Utf8Mb40900AsCi,
    #[iden = "utf8mb4_ru_0900_ai_ci"] Utf8Mb4Ru0900AiCi,
    #[iden = "utf8mb4_ru_0900_as_cs"] Utf8Mb4Ru0900AsCs,
    #[iden = "utf8mb4_zh_0900_as_cs"] Utf8Mb4Zh0900AsCs,
    #[iden = "utf8mb4_0900_bin"] Utf8Mb40900Bin,
    #[method = "unknown_to_string"] Unknown(String),
}
